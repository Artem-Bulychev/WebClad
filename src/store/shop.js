	...
	state: {
		shopList: [
			...
			},
			{
				...
				level: 'easy',
				gallery: [{ name: 'Cocteil', img: require('../assets/img/4.png') }],
				language: 'Ru',
			...
			},
			{
				...
				level: 'medium',
				gallery: [{ name: 'Gild', img: require('../assets/img/7.png') }],
				language: 'Ru',
				autor: 'Иванов Иван Иванович',
				price: '999999',
				maket: 'https://t.me/Figmab',
			},
			{
				...
				level: 'medium',
				gallery: [{ name: 'Webovio', img: require('../assets/img/10.png') }],
				language: 'Ru',
				autor: 'Иванов Иван Иванович',
				price: '999999',
				maket: 'https://t.me/Figmab',
			...
			{
				id: 5,
				title: 'Очень длинное название макета очень длинное название макетаОчень длинное название макета очень длинное название макета',
				descr: 'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aliquid asperiores illum assumenda nam repellat aspernatur reprehenderit sapiente sequi deleniti, voluptate placeat non labore libero delectus quod nesciunt inventore voluptates odio?Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aliquid asperiores illum assumenda nam repellat aspernatur reprehenderit sapiente sequi deleniti, voluptate placeat non labore libero delectus quod nesciunt inventore voluptates odio?',
				img: require('../assets/img/11.png'),
				level: 'medium',
				gallery: [{ name: 'Step', img: require('../assets/img/11.png') }],
			},
			{
				id: 6,
				title: 'Food wagon',
				...
				level: 'hard',
				gallery: [{ name: 'Food wagon', img: require('../assets/img/12.png') }],
			},
			{
				id: 7,
				title: 'Auraglow',
				...
				level: 'hard',
				gallery: [{ name: 'Auraglow', img: require('../assets/img/13.png') }],
			},
			{
				id: 8,
				title: 'Panto',
				...
				level: 'hard',
				gallery: [{ name: 'Panto', img: require('../assets/img/14.png') }],
			},
			{
				id: 9,
				title: 'GoTrieop',
				...
				level: 'hard',
				gallery: [{ name: 'GoTrieop', img: require('../assets/img/15.png') }],
			},
			{
				id: 10,
				title: 'Diamaint',
				...
				level: 'hard',
				gallery: [{ name: 'Diamaint', img: require('../assets/img/16.png') }],
			},
			{
				id: 11,
				title: 'Schoolio',
				...
				level: 'medium',
				gallery: [{ name: 'Schoolio', img: require('../assets/img/17.png') }],
			},
			{
				id: 12,
				title: 'FT Yoga',
				...
				level: 'medium',
				gallery: [{ name: 'FT Yoga', img: require('../assets/img/18.png') }],
			},
		],
	},
	mutations: {},
